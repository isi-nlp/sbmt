#ifndef   UTILITIES__MINI_DECODER_FILTERS_TPP
#define   UTILITIES__MINI_DECODER_FILTERS_TPP
...
public:
    ...
    std::size_t   cube_heap_poplimit_multiplier;
    graehl::optional_pair<sbmt::score_t> cube_heap_hist_fuzz;
    bool          separate_tag_virt;
    double        cube_heap_fuzz_exp;
...
#endif // UTILITIES__MINI_DECODER_FILTERS_TPP
