	...
	int Td_vocab_size)
{
	...
	H_output_layer.resize(H_vocab_size,output_embedding_dimension),
	D_output_layer.resize(D_vocab_size,output_embedding_dimension),
	...
	H_linear_layer.resize(output_embedding_dimension,output_embedding_dimension);
	D_linear_layer.resize(output_embedding_dimension,output_embedding_dimension);
	Td_linear_layer.resize(output_embedding_dimension,output_embedding_dimension);
	...
	this->H_vocab_size = H_vocab_size;
	this->D_vocab_size = D_vocab_size;
