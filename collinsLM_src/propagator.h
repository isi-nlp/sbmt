...
public:
	...
	AdderNode<Activation_function,Linear_layer> D1_hidden_activation_node,
							  Td1_hidden_activation_node,
							  d1_hidden_activation_node;
	Node<Output_word_embeddings> H_output_layer_node,
								  D_output_layer_node,
								  Td_output_layer_node,
								  d_output_layer_node;

	Node<Linear_layer> H_linear_node,
					   D_linear_node,
					   Td_linear_node;
...
public:
	...
	d_output_layer_node(&nn.d_output_layer, minibatch_size),
	H_linear_node(&nn.H_linear_layer,minibatch_size),
	D_linear_node(&nn.D_linear_layer,minibatch_size),
	...
	minibatch_size(minibatch_size)
    {
		...
		D1_hidden_activation_node.addChild(&H_linear_node);
		
		Td1_hidden_activation_node.addChild(&first_hidden_linear_node);
		Td1_hidden_activation_node.addChild(&H_linear_node);
		Td1_hidden_activation_node.addChild(&D_linear_node);
		
		d1_hidden_activation_node.addChild(&first_hidden_linear_node);
		d1_hidden_activation_node.addChild(&H_linear_node);
		d1_hidden_activation_node.addChild(&D_linear_node);
    ...
    void resize(int minibatch_size) {
	  ...
	  d_output_layer_node.resize(minibatch_size);
	  H_linear_node.resize(minibatch_size);
	  D_linear_node.resize(minibatch_size);
