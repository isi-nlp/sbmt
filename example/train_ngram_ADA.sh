...
$ROOT/src/trainNeuralNetwork --train_file $WORKDIR/train.ngrams --validation_file $WORKDIR/validation.ngrams --num_epochs $EPOCHS --words_file $WORKDIR/words --model_prefix $WORKDIR/$PREFIX --parameter_update ADAD --adagrad_epsilon 0.05 --learning_rate 1 --minibatch_size 8 || exit 1
