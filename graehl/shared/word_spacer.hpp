...
const multilineT multiline=multilineT();
  void kill_singlelineT_multilineT_warning(const singlelineT&,const multilineT&) {}
  void kill_singlelineT_multilineT_warning() { kill_singlelineT_multilineT_warning(singleline,multiline); }
}
