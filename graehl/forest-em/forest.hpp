...
//    GENIO_THROW("Forest: error reading (shouldn't happen - bug!).");
}
...
//    ,     "(OR #1(1 #2(4) #2) (2 #4(3) #2) (2 #2 #4) (1 5))"
    //, "(OR #1(2) #1 (2 3 #1 #2(6 7 8)) #2)"
};
...
//    o << "(parent=" << dbgstr(a.parent);
//    o << " child=" << dbgstr(a.child) << ")";
    o << "(parent=" << *a.parent;
    if (a.child) {
        o << " child=";
        o << *a.child;
