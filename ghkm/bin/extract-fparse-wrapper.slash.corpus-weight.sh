...
while [ $# -gt 0 ]; do
  ...
  PYTHONPATH=/home/nlg-01/chiangd/sbmt-hadoop /usr/usc/python/default/bin/python /home/nlg-02/pust/ghkm/bin/extract-fparse.slash.corpus-weight.py $EXTRACT_ARGS |
