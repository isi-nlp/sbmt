...
if __name__ == "__main__":
    for line in sys.stdin:
        etree, ftree, align, tags = line.rstrip().split("\t")
        corpora,genre = tags.strip().split()
        ...
        for line in rules.split("\n"):
            ...
            print line, "froot=%s fvars={{{%s}}} fesyn={{{%s %s}}} corpora=%s genre=%s" % (froot, " ".join(fvars), froot, eroot, corpora, genre)
