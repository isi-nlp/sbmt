...
# Input: eparse \t fparse \t align \t weight
...
if __name__ == "__main__":
    for line in sys.stdin:
        etree, ftree, align, weight = line.rstrip().split("\t")
        weight = float(weight)
        ...
        for line in rules.split("\n"):
            ...
            print line, "cwt=%g froot=%s fvars={{{%s}}} fesyn={{{%s %s}}}" % (weight, froot, " ".join(fvars), froot, eroot)
